...
<body class="fixed-navbar fixed-sidebar hide-sidebar" style="background-color: #F1F3F6;position: relative;" id="body">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li id="AGENDA" class="">
                <?php
                    ...
                    {
                        $html.='
                             <a href="javascript:void(0)" id="alerta"> <span class="nav-label">AGENDA</span></a>
                        ';
                        echo $html;
                    }
                    else
                    {
                        $html.='
                             <a href="agenda.php"> <span class="nav-label">AGENDA</span></a>
                        ';
                        echo $html;
                    }
                 ?>
            ...
            <li id="BIOMETRICO" class="">
                <a href="biometrico.php"> <span class="nav-label">BIOMÉTRICO</span></a>
            </li>
            <li id="NOVEDADES" class="">
                <a href="novedades.php"> <span class="nav-label">NOVEDADES</span></a>
            </li>
            <li id="PERMISOS" class="">
                <a href="permisos.php"> <span class="nav-label">PERMISOS</span></a>
            </li>
            <li id="PROGRAMACION" class="">
                <a href="programacion.php"> <span class="nav-label">PROGRAMACIÓN</span></a>
            </li>            
            <li id="SERVICIOS" class="">
                <?php
                    ...
                    {
                        $html.='
                            <a href="servicios.php"> <span class="nav-label">SERVICIOS</span></a>
                        ';
                        echo $html;
                    }                   
                 ?>
            ...
            <!-- <li id="SOLICITUDES" class="">
                       <a href="solicitudes.php"> <span class="nav-label">SOLICITUDES</span></a>
                   </li>     -->       
        </ul>
