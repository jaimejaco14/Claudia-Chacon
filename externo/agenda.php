...
<head>
    ...
    <!-- Page title -->
    <title>Beauty Soft | Agenda </title>
...
<div class="content">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="hpanel">
                <div class="panel-heading">AGENDA DE CITAS <a href="./" class="btn btn-primary btn-xs pull-right" data-toggle="tooltip" data-placement="bottom" title="Volver al inicio."><i class="fa fa-chevron-left"></i></a></div>
                        ...
                        <div class="tab-content">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="txtValDoc" placeholder="Documento de identidad"> 
                                                        <span class="input-group-btn"> 
                                                         ...
                                                         <span class="input-group-btn"> 
                                                            <button type="button" data-toggle="modal" data-target="#modalLogin" class="btn btn-info"><i class="fa fa-sign-in"></i>
                                                            </button> 
                                                        </span>
                                                </div>
                                            </div>
                            ...
                            <div id="step2" class="p-m tab-pane">
                                <div class="row">
                                    <div class="col-lg-3 text-center">
                                        <i class="pe-7s-pen fa-5x text-muted"></i>
                                            <p class="small m-t-md">
                                                <strong>Seleccione</strong> el servicio, la fecha / hora y el colaborador con el cual desea agendar su cita. 
                                            </p>
                                    </div>
                                    <div class="col-lg-9">
                                        <div class="row">
                                            <form id="formCliente" action="" method="POST">
                                                ...
                                                <input type="hidden" name="documCli" id="documCli">
                                                    ...
                                                    <select class="selectpicker form-control" id="servicioSel" name="servicioSel"  data-live-search="true" data-size="10"  style="width: 100%">
                                                        <option value="0">SELECCIONE</option>
                                                        
                                                            <?php 
                                           
                                                            $sql = mysqli_query($conn,"SELECT a.sercodigo, a.sernombre FROM btyservicio a ORDER BY a.sernombre");

                                                            while ($row = mysqli_fetch_array($sql)) 
                                                            {  
                                                                echo '<option value="'.$row['sercodigo'].'">'.utf8_encode($row['sernombre']).'</option>';

                                                            }

                                                            ?>                                            
                                                    </select>
                                                   <div class="alert alert-info" role="alert" id="descripcion" style="display: none; font-size: .8em; text-align: justify;"></div>
                                                    </div>
                                                            ...
                                                            <div class="row">                                    
                                                               <div class="col-md-12">
                                                                  <div class="input-group clockpicker" data-autoclose="true">
                                                                        <input type="text" class="form-control" value="00:00" name="hora_de" id="hora_de">
                                                    ...
                                                    <!-- <div class="form-group col-lg-6">
                                                    <label>Fecha</label>
                                                    <input type="text" value="" id="fechaCita" class="form-control" placeholder="FECHA" name="fechaCita">
                                                    </div>
                                                    <div class="form-group col-lg-6">
                                                    <label>Colaborador</label>
                                                    <select name="selCol" id="selCol" class="form-control">
                                ...
                                <div class="text-right m-t-xs">    
                                    <a class="btn btn-default next finish">Siguiente</a>
                                </div>
                            </div><!-- /step2 -->
