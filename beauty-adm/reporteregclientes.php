        ...
        <div class="hpanel">
            <div class="panel-body">
                ...
                <h2 class="font-light m-b-xs">
                    Reporte de Registro de clientes por Salón
                </h2>
            </div>
        </div>
    </div>
            ...
            <div class="hpanel">
                ...
                <div class="panel-body">
                        ...
                        <div id="step1" class="p-m tab-pane active">
                            ...
                            <h4 class="text-center" id="encabezado">Reporte de Registro de Clientes por Salón </h4>
                                <div id="content" style="display:none;">
                                    <table id="tbregsln" class="table table-hover">
                                        <thead>
                                            <tr>
                                                <th>Salón</th>
                                                <th>Manual</th>
...
<script type="text/javascript">
    $("#siguiente").click(function(e){
       ...
       /* $.ajax({
            type:'POST',
            url:'reportes/registroclientes.php',
            data:datos,
            beforeSend: function() 
                {
        ...
        $("#content").fadeIn(200);
        $("#salon").removeAttr('disabled');
        var listado = $('#tbregsln').DataTable({
            "ajax": {
            "method": "POST",
            "url": "reportes/registroclientes.php",
              ...
              buttons: [ 
                  {
                    ...
                    title:'BeautySoft - Registro de clientes por salon del '+f1+' al '+f2,
                  }
              ],
            "columns":[
              {"data": "sln"},
