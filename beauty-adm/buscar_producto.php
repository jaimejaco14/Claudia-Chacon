...
if ($id = $_POST['nombre']) {
    ...
    $sql="SELECT distinct(a.procodigo), a.crscodigo, a.imvcodigo, a.umecodigo, a.pronombre, a.prodescripcion, a.proimagen, a.proalias, 
a.proestado, a.procreacion, a.proultactualizacion, f.grunombre, a.procodigoanterior FROM btyproducto a JOIN btycaracteristica b ON a.crscodigo=b.crscodigo JOIN btysublinea c ON b.sblcodigo=c.sblcodigo JOIN btylinea d ON c.lincodigo=d.lincodigo JOIN btysubgrupo e ON d.sbgcodigo=e.sbgcodigo JOIN btygrupo f ON e.grucodigo=f.grucodigo JOIN btycodigobarras cb ON cb.procodigo=a.procodigo WHERE a.proestado = 1 AND (a.pronombre LIKE '%".$id."%' or a.procodigo =  '$id' or a.procodigoanterior LIKE '%".$id."%' OR cb.cbrcodigo= '$id')";
} else {
    

$sql="SELECT a.procodigo, a.crscodigo, a.imvcodigo, a.umecodigo, a.pronombre, a.prodescripcion, a.proimagen, a.proalias, 
...
if ($result->num_rows > 0) {
  ...
  echo '<div class="alert alert-danger" role="alert">No hay resultados para la búsqueda.</div>';
}
