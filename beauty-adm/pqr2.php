...
<div class="register-container" style="margin-top: -4%;">
                  ...
                  <form action="" method="POST" id="Form">
            			 ...
            			 <div class="form-group">
	            				<label for="">Seleccione Tipo</label>
	               				<select class="js-source-states" required="required" id="tipo" name="tipo" style="width: 100%"> 
                   ...
                   <div class="form-group">
                      <label for="">Seleccione Salón</label>
                        <select class="js-source-states" id="salon" name="sln" required="required" style="width: 100%"> 
                                <option value="0" selected>SELECCIONE SALÓN</option>                               
                                <?php 
                                    include("conexionExt.php");
	...
	<!--             		<div class="hr-line-dashed"></div> -->
                  ...
                  <div class="g-recaptcha" data-sitekey="6LdQahwTAAAAAABGi-14v2FsBuTis7Icwd8-Tddw"></div>
                    ...
                    <button class="ladda-button ladda-button-demo btn btn-primary pull-right" type="submit" data-style="zoom-in">ENVIAR</button>
	            		</div>
                 </form>
					</div>
