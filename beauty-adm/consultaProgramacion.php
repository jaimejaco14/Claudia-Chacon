                            ...
                            <div class="row">
                                <div class="hpanel">
                                    <div class="panel-heading">
                                        ...
                                        Programación de <?php echo $_GET['nombre']; ?><a href="#/" id="ignorePDF"></a>
                                       <!--  <button class="btn btn-default pull-right" id="btn_export" title="Cargar imagen para guardar"></i> <i class="pe-7s-date text-info"></i></button> -->
                                        ...
                                        <div class="dropdown pull-right">
                                          ...
                                          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                            <li><a href="#/" class="btn-Convert-Html2Image">PNG</a></li>
                                          </ul>
                                        </div>
                                    </div>
        ...
        $('#calendar').fullCalendar({
            ...
            eventRender: function(event, element)
            {
                ...
                switch (event.res) 
                {
                    ...
                    default:
                         element.find(".fc-title").append("<center><b>"+event.turno+" </b> </center>");
                    break;
                }
