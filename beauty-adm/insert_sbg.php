...
if ($_POST['nombre'] != "") {
	...
	$desc = $_POST['desc'];
	$gru = $_POST['grupo'];
	$max = "SELECT MAX(sbgcodigo) as m FROM `btysubgrupo`";
...
$sql = "INSERT INTO `btysubgrupo`(`sbgcodigo`, `grucodigo`, `sbgnombre`, `sbgalias`, `sbgdescripcion`, `sbgimagen`, `sbgestado`) VALUES ($codigo, $gru, '$nombre', '$alias', '$desc','$img_name',1)";
if ($conn->query($sql)) {
	echo "TRUE";
}
}