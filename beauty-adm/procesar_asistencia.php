...
$("#salon").select2({
    placeholder: "Seleccione salón(es)"
});
...
$("#siguiente").click(function(e){
    ...
    $.ajax({
        type:'POST',
        url:'biometrico/procesar_biometrico.php',
        data:datos,
        beforeSend: function() 
            {
...
$("#exppdf").click(function(e){
    ...
    var salon=$("#salon").val();
    var salontxt=$("#salon option:selected").text();
    window.open('biometrico/export_asistencia.php?opc=PDF&mes='+mes+'&salon='+salon+'&mestxt='+mestxt+'&salontxt='+salontxt);
});
$("#expexcel").click(function(e){
    ...
    var salon=$("#salon").val();
    var salontxt=$("#salon option:selected").text();
    window.open('biometrico/export_asistencia.php?opc=EXCEL&mes='+mes+'&salon='+salon+'&mestxt='+mestxt+'&salontxt='+salontxt);
});


/**********************************************************LOGS**********************************************************************/
$("#btnlogs").click(function(e){
    $("#detallemodallogs").load('biometrico/modallogspro.php');
...
$("#btnfilter").click(function(e){
        ...
        $.ajax({
            url:'biometrico/filtroprocess.php',
            type:'POST',
