                                ...
                                {               
                                    echo "<tr class='tbody'>"; 
                                        ...
                                        echo '<td>' . utf8_encode($row['trcrazonsocial']) . '</td>';
                                            ...
                                            echo '<td><center><button class="btn btn-default" data-toggle="tooltip" data-placement="right" title="Quitar de programacion" onclick="eliminar('.$row['clbcodigo'].', \''.$fecha.'\', this)"><i class="pe-7s-trash text-info"></i></button></center></td>';
