...
VerificarPrivilegio("REPORTES (PDV)",$_SESSION['tipo_u'],$conn);
?>
<div id="">
        ...
        <div class="hpanel">
            <div class="panel-body">
                ...
                <h2 class="font-light m-b-xs">
                    Reporte de uso del Sube y baja
                </h2>
            </div>
        </div>
    </div>
            ...
            <div class="hpanel">
                ...
                <div class="panel-body">
                        ...
                        <div id="step1" class="p-m tab-pane active">
                                    ...
                                    <div class="text-center m-b-md">
                                        <div class="form-group col-md-6 col-md-push-3">
                                            ...
                                            <label for="selsalon2">Salon: </label><br>
                                                <select class="" name="selsalon2[]" id="selsalon2" data-error="Escoja una opcion" multiple="multiple" style="width: 100%">
                            ...
                            <h4 class="text-center" id="encabezado">Reporte de uso del Sube y baja </h4>
...
$("#siguiente").click(function(e){
    ...
    $.ajax({
        type:'POST',
        url:'reportes/p_repsubibaja.php',
        data:datos,
        beforeSend: function() 
            {
...
$("#exppdf").click(function(e){
    ...
    var sl=$("#selsalon2").val();
    var txtsl=$("#selsalon2 option:selected").text();
    var datos='opc=PDF&f1='+f1+'&f2='+f2+'&sln='+sl+'&txtsl='+txtsl;
    window.open('reportes/exportdetsubibaja.php?'+datos);
});
$("#expexcel").click(function(e){
    ...
    var sl=$("#selsalon2").val();
    var txtsl=$("#selsalon2 option:selected").text();
    var datos='opc=XLS&f1='+f1+'&f2='+f2+'&sln='+sl+'&txtsl='+txtsl;
    window.open('reportes/exportdetsubibaja.php?'+datos);
});
