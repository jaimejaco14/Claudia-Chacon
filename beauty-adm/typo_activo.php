...
<div>
    ...
    <!-- formulario de  marcas-->
        ...
        <form role="form" name="form" method="post"  action="insert_typo_activo.php">
        <div class="col-lg-7">
        <div class="hpanel">
 ...
 -->
     ...
     <br>
       <div class="form-group ">
                                    ...
                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input  class="form-control" type="text" name="nombrtypo" placeholder="Ingrese nombre" data-error="camp obligatorio" required>
