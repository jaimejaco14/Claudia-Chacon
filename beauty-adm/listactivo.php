...
if($_POST['nombre']){
    ...
    $sql= "SELECT ac.actnombre, ac.actfechacompra, ac.actmodelo, ac.actcodigo, ac.actimagen, ma.marnombre
            ...
            WHERE (ac.actnombre LIKE '%".$id."%' OR ac.actcodigo = '".$id."%' or ac.actcodigoexterno like '%".$id."%') and ac.actestado = 1";
}else{
    $sql = "SELECT ac.actnombre, ac.actfechacompra, ac.actmodelo, ac.actcodigo, ac.actimagen, ma.marnombre
            FROM btyactivo ac 
            natural join btyactivo_marca ma 
            WHERE ac.actestado = 1";
}
?>
                    ...
                    <div class="col-lg-3">
                        <div class="hpanel hgreen contact-panel" style="max-height:290px;min-height:290px;">
                            <div class="panel-body" style="min-height:200px;overflow-x: auto;">
                                ...
                                <div class="text-muted font-bold m-b-xs"><?php echo utf8_encode($row['marnombre']);?></div>
...
<script>
    $(".btn_detactivo").click(function(e){
