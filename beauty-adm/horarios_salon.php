...
function eliminar(id, este) {
    swal({
                    ...
                    function () {
                            ...
                            data: {horario: id, operacion: "delete"}
                                }).done(function (msg) {
...
function eliminar_hor_salon(id, este) {
    swal({
                        title: "¿Seguro que desea eliminar este horario?",
                        text: "",
                        type: "warning",
...
$('#btn2').click(function(){
    ...
    $(document).on('click', '#btn_pdf_horario', function() 
    {
        ...
        window.open("php/turnos/reporteHorariosSalon.php?opcion=pdf&codsalon="+codigosalon+"&salon="+salon+"");
    });
    ...
    $(document).on('click', '#btn_horarioExc', function() 
    {
        ...
        window.open("php/turnos/reporteHorariosSalon.php?codsalon="+codigosalon+"&salon="+salon+"");
    });
