                    ...
                    <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                            ...
                                            $query_num_col = "SELECT atccodigo FROM btyactivo WHERE actestado = 1";
                                            ...
                                            $sql = "SELECT actnombre, actfechacompra, actmodelo, actcodigo, actimagen FROM `btyactivo` WHERE actestado = 1 limit $offset, $rowsPerPage";
