                ...
                if ($result1->num_rows > 0) 
                {
                    ...
                    { 
                        ...
                        $e1             = $row['clbnotificacionemail'];
                            ...
                            /*if ($row['clbcodigoswbiometrico'] == "")                                 
                            {
                                $biometrico = $row['clbcodigoswbiometrico'];
                            }*/
        ...
        <form role="form" method="post" enctype="multipart/form-data" id="form_edit_colab" >
            ...
            <div class="form-group" id="divsexo">
               ...
               <?php 
                ...
                $a = mysqli_query($conn, "SELECT clbsexo FROM btycolaborador WHERE trcdocumento = '".$id_colaborador."' ");
                    $ro = mysqli_fetch_array($a);
                    if ($ro['clbsexo'] == 'M') {
                        echo '<option selected value="M">MASCULINO</option><option value="F">FEMENINO</option>';
                        //echo '<option value="F">FEMENINO</option>';
                    }else{
                        echo '<option selected value="F">FEMENINO</option><option value="M">MASCULINO</option>';
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input  type="date" class="form-control" name="fecha" id="fecha" value="<?php echo $fecha ?>" placeholder="AAAA-MM-DD" max="<?php echo $today;?>" format="YYYY-MM-DD" data-error="campo obligatorio" required><div class="input-group-btn"><input style="width: 50px" type="text" class="form-control" id="edad" name="edad" readonly></div>
                </div>
            ...
            <div class="form-group">
                ...
                <select zize="30" class="form-control" name="barrio" id="barrio" data-error="Escoja una opcion" required>
                    <?php echo '<option value="'.$id_barrio.'">'.$barrio.'</option>'; ?>
                </select>
                <div class="help-block with-errors"></div>
            </div><!--Barrio-->
            ...
            <div class="form-group">
                ...
                <input  type="email" class="form-control text-uppercase" name="email" onchange="this.value=this.value.toUpperCase();" pattern="[a-zA-Z0-9]+[.[a-zA-Z0-9_-]+]*@[a-z0-9][\\w\\.-]*[a-z0-9]\\.[a-z][a-z\\.]*[a-z]$" id="email" placeholder="Email" data-error="Ingrese un direccion de correo valida" <?php echo "value='".$email."'"; ?>=".">
                <div class="help-block with-errors"></div>
            </div><!--Email-->
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <button type="submit" value="Guardar cambios" class="btn btn-success">Guardar Cambios </button>
           </form>
        </div><!--panel body-->
    </div><!--hpanel-->
</div><!--panel-->
