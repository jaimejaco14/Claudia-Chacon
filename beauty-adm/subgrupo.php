<?php
    ...
    VerificarPrivilegio("SUBGRUPO", $_SESSION['tipo_u'], $conn);
    RevisarLogin();
        ...
        <div class="panel-body">
            ...
            <div id="hbreadcrumb" class="pull-right m-t-lg">
                <ol class="hbreadcrumb breadcrumb">
                    ...
                    <li class="active">
                        <a href="subgrupo.php"><span>Subgrupo</span></a>
                    </li>
                </ol>
            </div>
            <div class="col-md-9">
                        ...
                        <form id="form_tipo" method="post">
                            <div class="modal-content">
                                <div class="modal-header text-center">
                                    <h4 class="modal-title">Nueva subgrupo</h4>
                                    <!-- <small class="font-bold">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</small> -->
                                </div>
                                <div class="modal-body">
                                    <div class="form-gruop">
                                        <label>Nombre</label>
                                        <input class="form-control" type="text" name="nombre" id="nombre" maxlength="50" placeholder="Nombre del subgrupo" onkeyup="this.value=this.value.toUpperCase();" required>
                                        <div id="nom"></div>
                                    </div>
                                    <br>
                                    <div class="form-gruop">
                                        <label>Alias</label>
                                        <input class="form-control" type="text" name="alias" id="alias" maxlength="15" placeholder="Alias del subgrupo" onkeyup="this.value=this.value.toUpperCase();" required>
                                    </div>
                                    <br>
                                    <div class="form-gruop">
                                        <label>Descripción del subgrupo</label>
                                        <textarea name="desc" id="desc" class="form-control" placeholder="Descripción del subgrupo" required></textarea>
                                    </div>
                                    <br>
                                    <div class="form-gruop">
                                        <label>Imagen</label>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" name="cod" id="cod">
                                        <label>Nombre</label>
                                        <input class="form-control" type="text" name="upnombre" id="upnombre" maxlength="50" placeholder="Nombre del subgrupo" onkeyup="this.value=this.value.toUpperCase();" required>
                                        <div id="upnom"></div>
                                    </div>
                                    <br>
                                    <div class="form-gruop">
                                        <label>Alias</label>
                                        <input class="form-control" type="text" name="upalias" id="upalias" maxlength="15" placeholder="Alias del subgrupo" onkeyup="this.value=this.value.toUpperCase();" required>
                                    </div>
                                    <br>
                                    <div class="form-gruop">
                                        <label>Descripción del subgrupo</label>
                                        <textarea name="updesc" id="updesc" class="form-control" placeholder="Descripción del subgrupo" required></textarea>
                                    </div>
                                    <br>
                                    <div class="form-gruop">
                                        <label>Imagen</label>
                                ...
                                <div id="pre" class="form-gruop">
                                    <label>Grupo<a title="Editar clasificacion" onclick="$('#uptipo').attr('required',true); $('#upgrupo').attr('required',true); $('#fil').attr('hidden',false); $('#pre').attr('hidden',true);"><i class="fa fa-edit"></i></a></label>
            ...
            <div class="row">
                <div class="col-lg-12">
                            <div class="input-group">
                                <input class="form-control" type="text" id="inputbuscar" name="inputbuscar" placeholder="Nombre del subgrupo">
                                <div class="input-group-btn">
                                    <button id="busca" name="busca" class="btn btn-default"><i class="fa fa-search text-info"></i></button>
                                    <a ><button class="btn btn-default" data-toggle="modal" data-placement="right" title="Nueva subgrupo" data-target="#myModal"><i class="fa fa-plus-square-o text-info"></i>
                                        </button></a>
                                </div>
                                <div class="input-group">
...
function Eliminar(id, este) {
    swal({
        title: "¿Seguro que desea eliminar este subgrupo?",
        text: "",
        type: "warning",
...
$('#nombre').blur(function (){
    ...
    success : function(data) {
           if (data != "") {
                $('#nom').html('<div id="Error" class="help-block with-type-errors"> <input tipo="text" hidden required /> <font color="red">Este subgrupo ya existe, intente con uno diferente.</font></div>')
           } else { 
                $('#nom').html('')
           }
        }
...
$('#upnombre').blur(function (){
    ...
    success : function(data) {
           if (data != "") {
                $('#upnom').html('<div id="Error" class="help-block with-type-errors"> <input tipo="text" hidden required /> <font color="red">Este Subgrupo ya existe, intente con uno diferente.</font></div>')
           } else { 
                $('#upnom').html('')
           }
        }
