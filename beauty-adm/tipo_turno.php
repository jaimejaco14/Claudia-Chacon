                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="txthide_horario" id="txthide_horario">
                        ...
                        <select class="form-control" id="upturno" name="upturno">
                            ...
                            $sql = "SELECT `trncodigo`, `trnnombre`, `trndesde`, `trnhasta`, `trncolor`, `trnestado` FROM `btyturno` WHERE trnestado = 1 ORDER BY trnnombre";
                            $result = $conn->query($sql);
                            while ($row = $result->fetch_assoc()) {
                                echo "<option value='".$row['trncodigo']."'>".$row['trnnombre']."</option>";
                            }    
                            ?>
                        </select>
                    </div>
