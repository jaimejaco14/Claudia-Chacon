<?php
    ...
    VerificarPrivilegio("SUBLINEA", $_SESSION['tipo_u'], $conn);
    RevisarLogin();
        ...
        <div class="panel-body">
            ...
            <div id="hbreadcrumb" class="pull-right m-t-lg">
                <ol class="hbreadcrumb breadcrumb">
                    ...
                    <li class="active">
                        <a href="sublinea.php"><span>Subl&iacute;nea</span></a>
                    </li>
                </ol>
            </div>
            <div class="col-md-9">
                        ...
                        <form id="form_tipo" method="post">
                            <div class="modal-content">
                                <div class="modal-header text-center">
                                    <h4 class="modal-title">Nueva Subl&iacute;nea</h4>
                    ...
                    <div class="modal fade" id="update" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <form id="upform_tipo" method="post">
                            <div class="modal-content">
                                <div class="modal-header text-center">
                                    <h4 class="modal-title">Editar Subl&iacute;nea</h4>
                                    <!-- <small class="font-bold">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</small> -->
                                </div>
                                <div class="modal-body">
                                    <div class="form-gruop">
                                ...
                                <div id="pre" class="form-gruop">
                                    <label>LINEA <a title="Editar clasificacion" onclick="$('#uptipo').attr('required',true); $('#upgrupo').attr('required',true); $('#upSubgrupo').attr('required',true); $('#upLinea').attr('required',true); $('#fil').attr('hidden',false); $('#pre').attr('hidden',true);"><i class="fa fa-edit"></i></a></label>
            ...
            <div class="row">
                <div class="col-lg-12">
                            <div class="input-group">
                                <input class="form-control" type="text" id="inputbuscar" name="inputbuscar" placeholder="Nombre de la Subl&iacute;nea">
                                <div class="input-group-btn">
                                    
                                    <button id="busca" name="busca" class="btn btn-default"><i class="fa fa-search text-info"></i></button>
                                    <a ><button class="btn btn-default" data-toggle="modal" data-placement="right" title="Nueva Subl&iacute;nea" data-target="#myModal"><i class="fa fa-plus-square-o text-info"></i>
                                        </button></a>
                                </div>
                                <div class="input-group">
...
function ok(a) {
    swal({
        title: a,
        text: "Ir a lista de Sublineas",
        type: "success",
        confirmButtonText: "Aceptar"
    },
    function () {
        window.location = "sublinea.php";
    });
}
function ko() {
    swal({
...
function Eliminar(id, este) {
    swal({
        title: "¿Seguro que desea eliminar esta sublinea?",
        text: "",
        type: "warning",
...
$('#nombre').blur(function (){
    ...
    success : function(data) {
           if (data != "") {
                $('#nom').html('<div id="Error" class="help-block with-type-errors"> <input tipo="text" hidden required /> <font color="red">Esta sublinea ya existe, intente con uno diferente.</font></div>');
           } else { 
                $('#nom').html('');
           }
        }
...
$('#upnombre').blur(function (){
    ...
    success : function(data) {
           if (data != "") {
                $('#upnom').html('<div id="Error" class="help-block with-type-errors"> <input tipo="text" hidden required /> <font color="red">Esta sublinea ya existe, intente con uno diferente.</font></div>');
           } else { 
                $('#upnom').html('');
           }
        }
...
$("#form_tipo").on("submit", function(e) {
    ...
    .done(function(res){
        if (res == "TRUE"){
            ok ("Nueva Sublinea guardada correctamente.");
        } else {
            ko ();
        }
    });
