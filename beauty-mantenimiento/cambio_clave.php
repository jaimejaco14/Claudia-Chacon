<?php 
    ...
    VerificarPrivilegio("MANTENIMIENTO", $_SESSION['tipo_u'], $conn);
    RevisarLogin();  
   // print_r($_POST); 
 ?> 
...
<head>
   ...
   <link rel="stylesheet" href="../lib/vendor/sweetalert/lib/sweet-alert.css" />
    <!-- <link rel="stylesheet" href="php/cambioclave/swal/sweetalert.min.css" /> -->
            ...
            <div class="hpanel">
                <div class="panel-body">
                        <form action="#" id="loginForm">
                            <input type="hidden" id="user" value="<?php echo $_SESSION['PDVuser_session'] ?>">
...
<!-- <script src="php/cambioclave/swal/sweetalert.min.js"></script> -->
    ...
    $(document).on('blur', '#currentpass', function() 
    {
        ...
        $.ajax({
            ...
            success: function (data) 
            {
                if (data != 1) 
                {
                    swal("La contraseña actual no es correcta", "Verifique de nuevo", "warning");
        ...
        $.ajax({
            ...
            success: function (data) 
            {
                ...
                if (data == 1) 
                {
                    ...
                    setTimeout(function(){ window.location="inicio.php";}, 1000);
