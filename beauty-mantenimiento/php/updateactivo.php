                      ...
                      <div class="col-md-6">
                            ...
                            <!-- nombre -->
                                <div class="form-group">
                                  <div class="col-md-2">
                                    <label>Codigo</label>
                                    <input  class="form-control text-center" type="text" name="" id="" value="<?php echo $codigo;?>" readonly>
                                  </div>
                                  <div class="col-md-10">
                                    <label>Nombre</label>
                  ...
                  <div class="panel-body">
                      <div class="row">
                        ...
                        <div class="form-group addrepuesto col-md-2">
                            <label>cantidad</label>
                            <div class="input-group">
                              <input  class="form-control number" name="cantrepuesto" type="number" id="cantrepuesto"  placeholder="Cant" data-error="Campo obligatorio" disabled  min="1">
