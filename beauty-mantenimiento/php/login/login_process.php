<?php
    ...
    if (mysqli_num_rows($res) > 0){
        ...
        if($rlog[0] == 1){
            ...
            $RsSesion=mysqli_query($conn, "INSERT INTO btysesiones (sescodigo, sesmodulo, usucodigo, seslogin, sesdireccionipv4wan, sestipodispotivo, sesnavegador, sesfechainicio, seshorainicio, sesfechafin, seshorafin, sesfallida, sesestado) VALUES('".$idsesion."', 'MANTENIMIENTO','".$rusr['usucodigo']."', '".$rusr['usulogin']."', '$ip', '$user_os', '$user_browser', CURDATE(), CURTIME(), CURDATE(), CURTIME(), 1, 0)")or die(mysqli_error($conn));
