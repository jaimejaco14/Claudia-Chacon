...
<aside id="menu" style="background-color: #FFF">
    <div id="navigation">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li id="ACTIVOS" class="">
                <a href="activos.php"> <span class="nav-label">ACTIVOS</span></a>
            </li>
            <li id="CLASIFICACION" class="">
                <a href="clasificacion.php"> <span class="nav-label">CLASIFICACION</span></a>
            </li>
            <li id="LUGAR" class="">
                <a href="lugararea.php"> <span class="nav-label">LUGARES Y AREAS</span></a>
            </li>
            <li id="MOVIMIENTOS" class="">
                <a href="movimientos.php"> <span class="nav-label">MOVIMIENTOS</span></a>
            </li>
            <li id="SERVICIOS" class="">
                <a href="mantenimiento.php"> <span class="nav-label">SERVICIOS</span></a>
            </li>
            <!-- <li id="REVISIONES" class="">
                         <a href="#"> <span class="nav-label">REVISIONES</span></a>
                     </li>   -->         
        </ul>
