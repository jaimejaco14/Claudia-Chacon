...
function sendSMS($teldest,$cons){
    ...
    $dataCoding = "0";
    //******************************************
    $message = "CLAUDIA CHACON precios de locura de lunes a jueves en tu sede Exito 77 Blower+Plancha $15mil - Manicure+Pedicure $15mil - Combo depilacion $20mil. Te esperamos!";
...
$sql="SELECT c.clicodigo, t.trctelefonomovil
        ...
        AND c.slncodigo in (1,3,4,5,6,7)";
