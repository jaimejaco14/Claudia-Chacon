                            ...
                            $sql = mysqli_query($conn, "INSERT INTO btyautorizaciones (autcodigo, auttipo_codigo, subtipo, slncodigo, clbcodigo, prmcodigo, usucodigo, observacion, autvalor, autfecha_autorizacion, autfecha_registro, authora_registro, autestado_tramite) VALUES('$max', '".$_POST['tipo']."', '".$_POST['subtipo']."', '".$_POST['sln']."', NULL, '".$colman."',  '".$_SESSION['codigoUsuario']."', '".strtoupper(utf8_decode($_POST['obs']))."', '".$_POST['val']."', '".$_POST['fec']."', CURDATE(), CURTIME(), 'RADICADO')  ")or die(mysqli_error($conn));
                                ...
                                {                                   
                                        ...
                                        /*require dirname(__FILE__).'../../../../lib/phpmailer/phpmailer/PHPMailerAutoload.php';
                                            ...
                                            $mail->addAddress('direccion.operaciones@claudiachacon.com', 'Karen Chavez');
                                            $mail->addAddress('asistente.proyectos@claudiachacon.com', 'Katerine Rincon');
                                            $mail->addAddress($salon['slnemail'], 'Beauty Soft');
                                            $mail->addAddress('asistente.operaciones@claudiachacon.com', 'Richard Mendoza');
                                            $mail->addAddress('asistente.contable1@claudiachacon.com', 'Claudia Villa');*/
                                        ...
                                        $message = '<html><style>th{font-size: .9em;}</style>
                                                ...
                                                $message.='
                                                        <tr>
                                                            <th>Tipo:</th>
                                                            <th style="text-align: left;">'. $fetchTipo[0].'</th>
                                                        </tr>
                                                        <tr>
                                                            <th>Subtipo:</th>
                                                        ...
                                                        <tr>
                                                            <th>Sal&oacute;n:</th>
                                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_encode($salon['slnnombre']))).'</th> 
                                                        </tr>
                                                        <tr>
                                                            <th>Valor:</th>
                                                            <th style="text-align: left;">'.$fetchCol[1].'</th>
                                                        </tr>
                                                        <tr>
                                                            <th>Beneficiario:</th>
                                                            <th style="text-align: left;">'.ucwords(strtolower($fetchCol[0])).'</th>
                                                        </tr>
                                                        <tr>
                                                            <th>Por concepto de:</th>
                                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_decode($_POST['obs']))).'</th>
                                                        </tr>
                                                        <tr>
                                                            <th>Aprobado por:</th>
                                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_decode($usuarioAprueba))).'</th>
                                                        </tr>
                                                        <tr style="background-color: #FF6666">
                                                            <th colspan="2">Este es un correo automatico, NO RESPONDER a este correo</th>
                                                        </tr>
                                                    </tbody></table>
                                                    ';

                                                    $mail->Subject = utf8_decode('Aut # '.$max.' - '.$salon['slnnombre'].' -  MANTENIMIENTO');
                                    ...
                                    $queryTipo = mysqli_query($conn, "SELECT a.nombre FROM btyautorizaciones_tipo a WHERE a.auttipo_codigo = '".$_POST['tipo']."' ");
                                        ...
                                        $message = '<html><style>th{font-size: .9em;}</style>
                                                ...
                                                $message.='
                                                        ...
                                                        <tr>
                                                            <th>Valor:</th>
                                                            <th style="text-align: left;">'.$fetchCol['autvalor'].'</th>
                                                        </tr>
                                                        <tr>
                                                            <th>Beneficiario:</th>
                                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_encode($fetchCol['trcrazonsocial']))).'</th>
                                                        </tr>
                                                        <tr>
                                                            <th>Por concepto de:</th>
                                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_decode($_POST['obs']))).'</th>
                                                ...
                                                $mail->Subject = utf8_decode('Aut # '.$max.' - '.$salon['slnnombre'].' - Beauty Soft - MANTENIMIENTO');
                                   ...
                                   //5 echo $s;
                                    ...
                                    $queryTipo = mysqli_query($conn, "SELECT a.nombre FROM btyautorizaciones_tipo a WHERE a.auttipo_codigo = '".$_POST['tipo']."' ");
                                        ...
                                        $message = '<html><style>th{font-size: .9em;}</style>
                                                ...
                                                <thead>
                                                    <tr style="background-color: #d2e3fc">
                                                      <th colspan="2"><center>BEAUTY SOFT - '.$salon['slnnombre'].' - AUTORIZACIONES</center></th>
                                                    </tr>
                                                    <tr style="background-color: #c9ffc4">
                                                        <th colspan="2">Autorizaci&oacute;n '.$tipoFetch[1].' # '.$max.'</th>
                                                    </tr>
                                                ...
                                                $mail->Subject = utf8_decode('Aut # '.$max.' | Beauty Soft - MANTENIMIENTO');
                    ...
                    if ($sql) 
                    {
                                ...
                                $message = '<html><style>th{font-size: .9em;}</style>
                                                ...
                                                $message.='
                                                        ...
                                                        <tr>
                                                            <th>Porcentaje:</th>
                                                            <th style="text-align: left;">'.$_POST['por'].'%</th>
                                                        </tr>
                                                        <tr>
                                                            <th>Beneficiario:</th>
                                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_encode($fetchCol['trcrazonsocial']))).'</th>
                                ...
                                $mail->Subject = utf8_decode('Aut # '.$max.' | Beauty Soft - PAGO PRODUCCION');
                ...
                elseif ($_POST['tipo'] == '2') 
                {
                    ...
                    if ($sql) 
                    {
                        //echo $subtipo;
                                ...
                                $mail->addAddress('asistente.operaciones@claudiachacon.com', 'Richard Mendoza');
                                $mail->addAddress('gestionhumana@claudiachacon.com', 'Elaine Tapias');
                                $mail->addAddress($salon['slnemail'], 'Beauty Soft');
                                ...
                                $mail->Subject = utf8_decode('Aut # '.$max.' | Beauty Soft - PAGO DIARIO');
                    ...
                    if ($sql) 
                    {
                        ...
                        //echo $subtipo;
                               ...
                               $s = "SELECT a.beneficiario, CONCAT('$',FORMAT(a.autvalor,0))AS autvalor FROM btyautorizaciones a WHERE a.autcodigo = $max";
                                ...
                                $mail->addAddress('direccion.administrativa@claudiachacon.com', 'Viviana Gándara');

                                if($_POST['sln']!=0){
                                    $mail->addAddress('asistente.operaciones@claudiachacon.com', 'Richard Mendoza');
                                    $mail->AddCC($salon['slnemail'], 'Beauty Soft');
                                }

                                /*******ADICION DE CORREOS DEPENDIENDO DE SUBTIPO PROVISIONAL POR ODONTOLOGÍA y OPTOMETRÏA********/
                                if($_POST['subtipo']=='52'){//ODONTOLOGIA
                                    $mail->addAddress('dent.class@hotmail.com', 'DentClass');
                                    //$mail->addAddress('jhonfb2@hotmail.com', 'prueba 52');
                                    $mail->AddCC('gestionhumana@claudiachacon.com');
                                    $mail->AddCC('asistente.gestionhumana@claudiachacon.com');
                                }else if($_POST['subtipo']=='53'){//OPTOMETRIA
                                    $mail->addAddress('opticaribesa@yahoo.com', 'Carmen Tapia');
                                    //$mail->addAddress('carmen.tapia@opticaribe.com', 'Carmen Tapia');
                                    //$mail->addAddress('jhonfb2@hotmail.com', 'prueba 53');
                                    $mail->AddCC('gestionhumana@claudiachacon.com');
                                    $mail->AddCC('asistente.gestionhumana@claudiachacon.com');
                                }
                                /************************************************************************************/
                                ...
                                $message = '<html><style>th{font-size: .9em;}</style>
                                                ...
                                                $message.='
                                                        ...
                                                        <tr>
                                                            <th>Beneficiario:</th>
                                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_decode($fetchCol[0]))).'</th>
                                                        </tr>
                                                        <tr>
                                                            <th>Por concepto de:</th>
                                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_decode($_POST['obs']))).'</th>
                                                        ...
                                                        <tr>
                                                         ...
                                                         <tr style="background-color: #FF6666">
                                                            <th colspan="2">Este es un correo automatico<br> NO RESPONDA a este correo</th>
                                                        </tr>
                                                    </tbody></table>
                                                    ';


                                $mail->Subject = utf8_decode('Aut # '.$max.' | Beauty Soft - BONO ESPECIAL');
                              ...
                              $s = "SELECT c.trcrazonsocial, CONCAT('$',FORMAT(a.autvalor,0))AS autvalor FROM btyautorizaciones a JOIN btycolaborador b ON a.clbcodigo=b.clbcodigo JOIN btytercero c ON c.tdicodigo=b.tdicodigo AND c.trcdocumento=b.trcdocumento WHERE a.clbcodigo =  '".$_POST['col']."' AND a.autcodigo = $max";
                                ...
                                $message = '<html><style>th{font-size: .9em;}</style>
                                                ...
                                                $message.='
                                                        ...
                                                        <tr>
                                                            <th>Beneficiario:</th>
                                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_encode($fetchCol[0]))).'</th>
                                                        </tr>
                                                        <tr>
                                                            <th>Por concepto de:</th>
                                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_decode($_POST['obs']))).'</th>
                                ...
                                $mail->Subject = utf8_decode('Aut # '.$max.' | Beauty Soft - REEMBOLSOS Y PAGOS MISCELANEOS');
                                ...
                                {                                   
                                        ...
                                        $message = '<html><style>th{font-size: .9em;}</style>
                                                ...
                                                $message.='
                                                    ...
                                                    $mail->Subject = utf8_decode('Aut # '.$max.' - '.$salon['slnnombre'].' -  CAJA MENOR');
                            ...
                            if ($sql) 
                            {
                                    ...
                                    $queryTipo = mysqli_query($conn, "SELECT a.nombre FROM btyautorizaciones_tipo a WHERE a.auttipo_codigo = '".$_POST['tipo']."' ");
                                        ...
                                        $message = '<html><style>th{font-size: .9em;}</style>
                                                ...
                                                $mail->Subject = utf8_decode('Aut # '.$max.' - '.$salon['slnnombre'].' - Beauty Soft - CAJA MENOR');
                                   ...
                                   //5 echo $s;
                                    ...
                                    $queryTipo = mysqli_query($conn, "SELECT a.nombre FROM btyautorizaciones_tipo a WHERE a.auttipo_codigo = '".$_POST['tipo']."' ");
                                        ...
                                        $message = '<html><style>th{font-size: .9em;}</style>
                                                ...
                                                $mail->Subject = utf8_decode('Aut # '.$max.' | Beauty Soft - CAJA MENOR');
        ...
        case 'anular':
                    ...
                    if ($sql) 
                    {
                            ...
                            elseif ($row['auttipo_codigo'] == 4)
                            {
                                ...
                                $mail->addAddress('direccion.administrativa@claudiachacon.com', 'Viviana Gándara');
                                if($row['slncodigo']!='0'){
                                    $mail->AddCC('asistente.operaciones@claudiachacon.com', 'Richard Mendoza');
                                    $mail->AddCC($row['slnemail'], 'Beauty Soft');
                                }
                                //ADICION TEMPORAL PARA CONVENIOS DE ODONTOLOGIA Y OPTOMETRIA
                                if($row['subtipo']=='52'){
                                    $mail->addAddress('dent.class@hotmail.com', 'DentClass');
                                    //$mail->addAddress('jhonfb2@hotmail.com', 'prueba 52');//PRUEBA
                                    $mail->AddCC('gestionhumana@claudiachacon.com');
                                    $mail->AddCC('asistente.gestionhumana@claudiachacon.com');
                                }else if($row['subtipo']=='53'){
                                    //$mail->addAddress('carmen.tapia@opticaribe.com', 'Carmen Tapia');
                                    $mail->addAddress('opticaribesa@yahoo.com', 'Carmen Tapia');
                                    //$mail->addAddress('jhonfb2@hotmail.com', 'prueba 53');//PRUEBA
                                    $mail->AddCC('gestionhumana@claudiachacon.com');
                                    $mail->AddCC('asistente.gestionhumana@claudiachacon.com');
                                }
                            }
                            ...
                            $message = '<html><style>th{font-size: .9em;}</style>
                                    ...
                                    $message.='
                                        ...
                                        <tr>
                                            <th>Valor:</th>
                                            <th style="text-align: left;">'.$row['autvalor'].'</th>
                                        </tr>
                                        <tr>
                                            <th>Beneficiario:</th>
                                            <th style="text-align: left;">'.strtoupper(utf8_encode($row['colaborador'])).'</th>
                                        </tr>
                                        <tr>
                                            <th>Por concepto de:</th>
                                        ...
                                        <tr>
                                            <th>Anulado por:</th>
                                            <th style="text-align: left;">'.utf8_decode($row['autoriza']).'</th>
                                        </tr>
                                        <tr style="background-color: #FF6666">
                                            <th colspan="2">Este es un correo automatico<br>NO RESPONDA a este correo</th>
                                        </tr>
                                    ...
                                    $mail->Subject = utf8_decode('Autorizacion # '.$row[0].' ANULADA');
            ...
            case 'reenviar':
                    ...
                    $message = '<html><style>th{font-size: .9em;}</style>
                                ...
                                <thead>
                                    ...
                                    <tr style="background-color: #c9ffc4">
                                        <th colspan="2">Autorizaci&oacute;n # '.$fetchReenvio['autcodigo'].'</th>
                                    </tr>
                                ...
                                $message.='
                                        <tr>
                                            <th>Tipo:</th>
                                            <th style="text-align: left;">'. $fetchReenvio['nombre'].'</th>
                                        </tr>
                                        <tr>
                                            <th>Subtipo:</th>
                                            <th style="text-align: left;">'.$fetchReenvio['subtipo_nombre'].'</th>
                                        </tr>                                                       
                                        <tr>
                                            <th>Fecha:</th>
                                            <th style="text-align: left;">'.$fetchReenvio['autfecha_autorizacion'].'</th>
                                        </tr>
                                        <tr>
                                            <th>Sal&oacute;n:</th>
                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_encode($fetchReenvio['slnnombre']))).'</th> 
                                        </tr>
                                        <tr>
                                            <th>Valor:</th>
                                            <th style="text-align: left;">'.$fetchReenvio['autvalor'].'</th>
                                        </tr>
                                        <tr>
                                            <th>Beneficiario:</th>
                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_encode($fetchReenvio['colaborador']))).'</th>
                                        </tr>
                                        <tr>
                                            <th>Por concepto de:</th>
                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_decode($fetchReenvio['observacion']))).'</th>
                                        </tr>
                                        <tr>
                                            <th>Aprobado por:</th>
                                            <th style="text-align: left;">'.ucwords(strtolower(utf8_decode($fetchReenvio['autoriza']))).'</th>
                                        </tr>
                                        <tr style="background-color: #FF6666">
                                            <th colspan="2">Este es un correo automatico, NO RESPONDER a este correo</th>
                                        </tr>
                    ...
                    $mail->Subject = utf8_decode('Reenvio Autorización # '.$fetchReenvio['autcodigo'].' | Beauty Soft - '.$tpaut);
                    ...
                    {
                        echo json_encode(array('res' => 1, 'codigo' => $fetchReenvio['autcodigo']));
                    }
