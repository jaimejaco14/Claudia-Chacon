          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="input-group">
                <input class="form-control" type="text" id="inputbuscar" name="inputbuscar" placeholder="Nombre del salon">
                <div class="input-group-btn">           
                  <button id="busca" name="busca" class="btn btn-default"><i class="fa fa-search text-info"></i></button>
                  <a href="new_salon.php"><button data-toggle="tooltip" data-placement="bottom" class="btn btn-default" title="Nuevo sal&oacute;n"><i class="fa fa-plus-square-o text-info"></i>
                  </button></a>
