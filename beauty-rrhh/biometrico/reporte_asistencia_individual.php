                        ...
                        <div id="step1" class="p-m tab-pane active">
                            ...
                            <div class="m-b-md" id="paso1">
                                <br>                          
                                    <div class="text-center m-b-md">
                                        ...
                                        <div class="form-group col-md-12 ">
                                            <div class="form-group col-md-4 col-md-push-4">
                                              ...
                                              <select class="form-control gen" id="colaborador" disabled></select>  
                                            </div>
                                    ...
                                    <div class="form-group col-md-12 ">
                                        <button class="btn pull-right" id="siguiente"  data-toggle="tooltip" data-placement="top" title="Siguiente"><span class="fa fa-chevron-circle-right" style=""></span></button>
                                    </div> 
...
$("#siguiente").click(function(e){
    ...
    if(col>0){
        ...
        $.ajax({
            type:'POST',
            url:'generar_reporte_individual.php',
            data:datos,
            beforeSend: function() 
                {
        ...
        swal('Elija un colaborador!','','warning')
    }
});
$("#exppdf").click(function(e){
    ...
    window.open('asistencia_individualPDF.php?'+datos);
});
...
$('#colaborador').on('show.bs.select', function (e) {
    ...
    $(document).on('keyup', '#fucker', function(event) {
        ...
        if(seek.length>3){
            $.ajax({
                url: 'loadcol_reporteindividual.php',
                type: 'POST',
                data:'txt='+seek,
                success: function(data){
                    if(data){
