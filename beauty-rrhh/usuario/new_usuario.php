        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                   ...
                   <!--  <div class="form-group col-lg-6">
                       <label>Usuario</label>
                       <input type="text" id="view_usu" id="view_usu" class="form-control" required readonly>
                                        ...
                                        <div class="panel-body">
                                            <form name="simpleForm" id="simpleForm"  onsubmit="return validate_password()" method="post">
                                                <div class="text-center m-b-md" id="wizardControl">
                                                    ...
                                                    <a class="btn btn-default" href="#step1" data-toggle="tab"> 1 - Datos personales</a>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-lg-12">
                                                                        ...
                                                                        <select  zize="30" class="form-control" name="tiu" id="tiu" data-error="Escoja una opcion" required>
                                                                            ...
                                                                            $result = $conn->query("SELECT tiucodigo, tiunombre FROM btytipousuario where tiuestado = 1 and tiucodigo in (4,5,6)");
                                                                            if ($result->num_rows > 0) {
                                                                                while ($row = $result->fetch_assoc()) {                
                                                                                    echo '<option value="'.$row['tiucodigo'].'">'.$row['tiunombre'].'</option>';
                                                                                }
...
$("#simpleForm").on("submit", function(event) {
            ...
            $.ajax({
                ...
                processData: false
                  ...
                  if (res == "TRUE"){
                          swal('Usuario creado exitosamente!','La contraseña de usuario es: Abcd1234','success');
                         swal({
                              title: "Usuario creado exitosamente!",
                              text: "La contraseña del usuario es: Abcd1234; recuerde que todos los usuarios inician sesion con su numero de cédula",
                              type: "success"
                            },
                        function () {
                            window.location = "new_usuario.php";
                        ...
                        swal('Oops!','No se ha podido crear el usuario','error');
           ...
           if (data == 0) {
              ...
              if (data == 1) {
                ...
                $('input:checkbox').removeAttr('checked');
                 ...
                 if (data == 2) {
                     swal("Salón asignado correctamente!", "", "success");
                        //$('#modalLoginusuario').modal("hide");
                        $('#sel_salones_acceso').val("Seleccione");
                        $('#fecha_desde').val("");
                        $('#fecha_hasta').val("");
