<?php 
	...
	switch ($_POST['opcion']) 
	{
		case 'changeState':
			...
			{
				$QueryEstado = mysqli_query($conn, "UPDATE btycolaborador SET clbacceso = 1, clbclave = '325a2cc052914ceeb8c19016c091d2ac' WHERE clbcodigo = '".$_POST['codcol']."' ");
			...
			{
				$QueryEstado = mysqli_query($conn, "UPDATE btycolaborador SET clbacceso = 0, clbclave = null WHERE clbcodigo = '".$_POST['codcol']."' ");
