...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  */
    h1{
      /*@editable*/color:#F9F8F7 !important;
  ...
  */
    h2{
      /*@editable*/color:#737475 !important;
      /*@editable*/font-family:Helvetica;
  ...
  */
    h3{
      /*@editable*/color:#E7B932 !important;
      /*@editable*/font-family:Helvetica;
  ...
  */
    #templatePreheader{
      /*@editable*/background-color:#181818;
      /*@editable*/border-top:0;
      /*@editable*/border-bottom:1px solid #737475;
    }
  /*
  @tab Preheader
                            ...
                            <tr>
                                <td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContainer" style="padding-top:9px; padding-bottom:9px;"><table class="mcnTextBlock" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                            ...
                            <h3 style="text-align: center;">Notificación de Programación</h3>

<h1 style="text-align: center;">Beauty Soft ERP</h1>
                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                            ...
                            <h2>Hola %nombre%<br>
<span style="font-family:open sans,helvetica neue,helvetica,arial,sans-serif"><span style="font-size:15px">En el siguiente enlace podrá ver la programación asignada.</span></span></h2>
                    ...
                    <table class="mcnImageContentContainer" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                        <tbody><tr>
                            <td class="mcnImageContent" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                    ...
                                    <a href="http://lorempixel.com/600/368" title="" class="" target="_blank">
                                        <img alt="" src="http://lorempixel.com/600/368" style="max-width:600px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage" width="564" align="middle">
                                    </a>
    ...
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" class="mcnButtonBlockInner" valign="top" align="center">
                <table class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #E7B932;" width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                        <tr>
                            <td class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 14px;" valign="middle" align="center">
                                <a class="mcnButton " title="Pre-order" href="http://192.168.1.202/beauty/consultaProgramacion.php?codigo=%codigo%&nombre=%nombre%" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #181818;">Ver Programación </a>
                            </td>
                        </tr>
                    </tbody>
                </table>
