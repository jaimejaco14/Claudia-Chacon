                	...
                	<table id="grilla" class="grilla table table-hover table-bordered" cellpadding="0" cellspacing="0">
	                  ...
	                  <tr>	                        
	                        ...
	                        <?php 
	                        	...
	                        	$queryFes = mysqli_query($conn, "SELECT DAY(a.fesfecha)AS dia, a.fesobservacion FROM btyfechas_especiales a WHERE MONTH(a.fesfecha) = MONTH('$fecha') and year(a.fesfecha)= year('$fecha') ORDER BY dia");
