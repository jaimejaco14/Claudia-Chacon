        ...
        <div class="panel-body">
            ...
            <div id="hbreadcrumb" class="pull-right m-t-lg">
                <ol class="hbreadcrumb breadcrumb">
                    ...
                    <li class="active">
                        <span>Ausencias Programadas</span>
                    </li>
                </ol>
            </div>
            <h2 class="font-light m-b-xs">
                Autorización de Ausencias
            </h2>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="hpanel">
            <ul class="nav nav-tabs">
                ...
                <button type="button" class="btn btn-link text-info" id="btn_reporteTotalPDF" title="Exportar Ausencias a PDF"><i class="fa fa-file-pdf-o"></i></button>
                <button type="button" class="btn btn-link text-info" id="btn_reporteTotalExcel" title="Exportar todos las Ausencias autorizadas a Excel"><i class="fa fa-file-excel-o"></i></button>
            ...
            <div class="tab-content">
                ...
                <div id="tab-2" class="tab-pane">
                    <div class="panel-body">
                        <strong>Listado de Ausencias programadas</strong>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Autorizar Ausencia</h4>
                ...
                <div class="col-md-12">
                     <div class="col-md-6">
                         ...
                         <div class="form-group">
                             <label for="">Codigo Ausencia</label>
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                             <label for="">Ausencia Desde</label>
                             <input type="text" class="form-control" disabled id="txt_perdesde">
                         </div> 

                         <div class="form-group">
                             <label for="">Ausencia Hasta</label>
...
/*=========================================================
=            FUNCION BUSCAR PERMISOS POR FECHA            =
=========================================================*/

var  tblPermisosFechas  = function() { 
   var tbl_est = $('#tbl_permisos_lista').DataTable({
    "ajax": {
      "method": "POST",
      "url": "busquedas_permisos.php",
      "data": {desde: $('#fecha_de_bus').val(), hasta:$('#fecha_hasta_bus').val()}
      },
      "columns":[
        {"data": "percodigo"},
        {"data": "trcrazonsocial"},
        ...
        {"data": "usu_aut"},
        {"data": "estado_tramite"},
        {"defaultContent": "<button type='button' id='btn_ver_permiso' title='Click para ver los detalles' class='btn btn-link text-info'><i class='fa fa-search'></i></button><button type='button' id='btnDelete' title='Click para eliminar' class='btn btn-link text-danger' style='margin-left: 3px'><i class='fa fa-times'></i></button><button type='button' id='btnAnular' title='Click para Anular' class='btn btn-link text-warning' style='margin-left: 3px'><i class='fa fa-minus'></i></button>"},
      ],"language":{
...
/*=====  End of FUNCION BUSCAR PERMISOS POR FECHA  ======*/
...
$(document).on('change', '#sel_estados', function() 
{
    ...
    if (estado == 0) 
    {
        swal("Seleccione el estado", "Advertencia", "warning");
    }
    else
    {
        tblPermisosEtado(estado);
    }
...
var  tblPermisosEtado  = function() { 
   var tbl_est = $('#tbl_permisos_lista').DataTable({
    "ajax": {
      "method": "POST",
      "url": "buscar_estado_permisos.php",
      "data": {estado: $('#sel_estados').val(),desde:$("#fecha_de_bus").val(),hasta:$("#fecha_hasta_bus").val()}
      },
      "columns":[
        {"data": "percodigo"},
        {"data": "trcrazonsocial"},
