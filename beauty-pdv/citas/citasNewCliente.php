			...
			$QueryCliente = mysqli_query($conn, $c);
				...
				if (mysqli_num_rows($QueryCliente) > 0) 
				{
					...
					if ($_POST['tiposangre'] == "") 
					{
						...
						$update = mysqli_query($conn, "UPDATE btycliente SET clisexo = '".$_POST['sexo']."', cliemail = '".utf8_decode(strtoupper($_POST['email']))."', clifechanacimiento = '".$fechana."', clitiposangre = '".strtoupper($_POST['tiposangre'])."', slncodigo=".$_POST['salon']." ,  usucodigo=".$_POST['user']." WHERE trcdocumento = '".$_POST['doc']."' ");
					...
					else
					{
						...
						$update = mysqli_query($conn, "UPDATE btycliente SET clifechaupdate=CURDATE(), clisexo = '".$_POST['sexo']."', cliemail = '".utf8_decode(strtoupper($_POST['email']))."', clifechanacimiento = '".$fechana."', clitiposangre = '".strtoupper($_POST['tiposangre'])."',  slncodigo=".$_POST['salon'].", clitiporegistro = 'INTERNO-PDF417' ,  usucodigo=".$_POST['user']." WHERE trcdocumento = '".$_POST['doc']."' ");
				...
				else
				{
					...
					if (mysqli_num_rows($QueryTercero) > 0) 
					{
						...
						if ($_POST['tiposangre'] == "") 
						{
							...
							$t =  "INSERT INTO btycliente (clicodigo, trcdocumento, tdicodigo, clisexo, ocucodigo, cliextranjero, cliemail, clifechanacimiento, clinotificacionemail, clinotificacionmovil, cliempresa, clifecharegistro, cliimagen, clitiporegistro, cliestado, cliclave, cliacceso, clitiposangre,slncodigo,usucodigo) VALUES($maxiCli, '".$rows['trcdocumento']."', '".$rows['tdicodigo']."', '".$_POST['sexo']."', '".$ocupacion."', '".$extranjero."', '".utf8_decode(strtoupper($_POST['email']))."',  '".$fechana."','".$_POST['ne']."', '".$_POST['nm']."', 'N', CURDATE(), 'default.jpg', 'INTERNO', 1, '', 0, '".strtoupper($_POST['tiposangre'])."',".$_POST['salon'].",".$_POST['user'].")";

						}
						else
						{
							$t =  "INSERT INTO btycliente (clicodigo, trcdocumento, tdicodigo, clisexo, ocucodigo, cliextranjero, cliemail, clifechanacimiento, clinotificacionemail, clinotificacionmovil, cliempresa, clifecharegistro, cliimagen, clitiporegistro, cliestado, cliclave, cliacceso, clitiposangre,slncodigo,usucodigo) VALUES($maxiCli, '".$rows['trcdocumento']."', '".$rows['tdicodigo']."', '".$_POST['sexo']."', '".$ocupacion."', '".$extranjero."', '".utf8_decode(strtoupper($_POST['email']))."',  '".$fechana."','".$_POST['ne']."', '".$_POST['nm']."', 'N', CURDATE(), 'default.jpg', 'INTERNO-PDF417', 1, '', 0, '".strtoupper($_POST['tiposangre'])."',".$_POST['salon'].",".$_POST['user'].")";
						}
						...
						$QueryNewcli = mysqli_query($conn, "INSERT INTO btytercero (tdicodigo, trcdocumento, trcdigitoverificacion, trcnombres, trcapellidos, trcrazonsocial, trcdireccion, trctelefonofijo, trctelefonomovil, brrcodigo, trcestado) VALUES('".$_POST['tipodoc']."', '".$_POST['doc']."', '".$dv."', '".strtoupper(utf8_decode($_POST['nombres']))."', '".strtoupper(utf8_decode($_POST['apellidos']))."', '".strtoupper(utf8_decode($_POST['nombres'] . " " . $_POST['apellidos'])) ."', '".$_POST['direccion']."', '".$_POST['fijo']."', '".$_POST['movil']."', '".$barrio."', 1)")or die(mysqli_error($conn));
							...
							if ($QueryNewcli) 
							{
								...
								if ($_POST['tiposangre'] == "") 
								{
									...
									$t =  "INSERT INTO btycliente (clicodigo, trcdocumento, tdicodigo, clisexo, ocucodigo, cliextranjero, cliemail, clifechanacimiento, clinotificacionemail, clinotificacionmovil, cliempresa, clifecharegistro, cliimagen, clitiporegistro, cliestado, cliclave, cliacceso, clitiposangre,slncodigo,usucodigo) VALUES($maxiCli, '".$rows['trcdocumento']."', '".$rows['tdicodigo']."', '".$_POST['sexo']."', '".$ocupacion."', '".$extranjero."', '".strtoupper(utf8_decode($_POST['email']))."', CASE WHEN '".$fechana."' = 'null' THEN ".$fechana." ELSE '".$fechana."' END ,'".$_POST['ne']."', '".$_POST['nm']."', 'N', CURDATE(), 'default.jpg', 'INTERNO', 1, '', 0, '".strtoupper($_POST['tiposangre'])."',".$_POST['salon'].",".$_POST['user'].")";

								}
								else
								{
									$t =  "INSERT INTO btycliente (clicodigo, trcdocumento, tdicodigo, clisexo, ocucodigo, cliextranjero, cliemail, clifechanacimiento, clinotificacionemail, clinotificacionmovil, cliempresa, clifecharegistro, cliimagen, clitiporegistro, cliestado, cliclave, cliacceso, clitiposangre,slncodigo,usucodigo) VALUES($maxiCli, '".$rows['trcdocumento']."', '".$rows['tdicodigo']."', '".$_POST['sexo']."', '".$ocupacion."', '".$extranjero."', '".strtoupper(utf8_decode($_POST['email']))."', CASE WHEN '".$fechana."' = 'null' THEN ".$fechana." ELSE '".$fechana."' END ,'".$_POST['ne']."', '".$_POST['nm']."', 'N', CURDATE(), 'default.jpg', 'INTERNO-PDF417', 1, '', 0, '".strtoupper($_POST['tiposangre'])."',".$_POST['salon'].",".$_POST['user'].")";
								}
