<?php
session_start();
if (!isset($_SESSION['PDVuser_session'])) 
{
    header("Location: login.php"); 
} 
else 
{
    if ($_SESSION['PDVuser_session'] != "BLOCKED") 
    {
        $_SESSION['PDVsession_bloqueada'] = $_SESSION['PDVuser_session'];
        $_SESSION['PDVuser_session'] = "BLOCKED";
    }
    else
    {
