...
$result = $items->crearDomicilio();

if($result == 1){    
    $itemRecords["domicilio"]=array(); 
        $itemDetails=array(
            "res" => "OK",
            "message" => "domicilio creado",
        ); 
       array_push($itemRecords["domicilio"], $itemDetails);
     
    http_response_code(200);   
    

    $values = array_values($itemRecords["domicilio"]);
    ...
    echo json_encode(
        array("message" => "No item found domicilio.")
    );
} 
