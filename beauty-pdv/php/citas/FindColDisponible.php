<?php
	...
	$fechaHoraAgendamiento2    	= explode(" ", $_POST["newdate"]);
	$fecha2                    	= $fechaHoraAgendamiento2[0];
	$hora2                     	= $fechaHoraAgendamiento2[1];

	$salon 					  	= $_SESSION['PDVslncodigo'];
	$oldservice 			  	= $_POST['oldservice'];
	$newservice 			  	= $_POST['newservice'];


	if ($_POST['oldservice'] == $_POST['newservice'])
	{
		$servicio = $_POST['oldservice'];
	}
	else
	{
		$servicio = $_POST['newservice'];
	}
