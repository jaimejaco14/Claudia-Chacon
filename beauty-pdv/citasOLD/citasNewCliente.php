			...
			$QueryCliente = mysqli_query($conn, $c);
				...
				if (mysqli_num_rows($QueryCliente) > 0) 
				{
					...
					else
					{
						...
						$update = mysqli_query($conn, "UPDATE btycliente SET clisexo = '".$_POST['sexo']."', cliemail = '".utf8_decode(strtoupper($_POST['email']))."', clifechanacimiento = '".$fechana."', clitiposangre = '".strtoupper($_POST['tiposangre'])."',  slncodigo=".$_POST['salon'].", clitiporegistro = 'INTERNO-PDF417' ,  usucodigo=".$_POST['user']." WHERE trcdocumento = '".$_POST['doc']."' ");
