        ...
        <div class="panel-body">
            ...
            <div id="hbreadcrumb" class="pull-right m-t-lg">
                <ol class="hbreadcrumb breadcrumb">
                    ...
                    <li class="active">
                        <span>Reporte de Agendamiento</span>
                    </li>
                </ol>
            </div>
            <div class="col-md-12">
            	<div class="col-md-2">
            		<input type="text" name="" id="fechaDesde" class="form-control" placeholder="Desde" required="required" pattern="" title="">
                </div>
                <div class="col-md-2">
            		<input type="text" name="" id="fechaHasta" class="form-control" disabled placeholder="Hasta" required="required" pattern="" title="">
                </div>
                <div class="col-md-3">
                   <select class="selectpicker" name="" id="selCargo" data-width="100%" data-live-search-placeholder="Todos los cargos" disabled title="Seleccione Cargo">                                                                
                                                                                
                    </select> 
                </div>
                <div class="col-md-3">
                    <div class="input-group m-b"><span class="input-group-addon"> <input type="checkbox" id="chkTodos"> </span>  <select class="selectpicker" name="" id="selColaborador"  data-live-search="true" data-width="100px">           
                                                                            
                    </select></div>
                  
                </div>
                <div class="col-md-2">
                    <button type="button" id="btnFiltrar" class="btn btn-info btn-block">Filtrar</button>
                </div>
            </div>
           ...
           <!--  <div class="col-md-12">
                <div class="col-md-3">
                    <div class="radio">
                        <label>
                            <input type="radio" name="estados" id="agendada" value="1">
                            Agendadas
                        </label>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="radio">
                        <label>
                            <input type="radio" name="estados" id="atendida" value="2">
                            Atendidas 
                        </label>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="radio">
                        <label>
                            <input type="radio" name="estados" id="inasistencia" value="3">
                            Inasistidas
                        </label>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="radio">
                        <label>
                            <input type="radio" name="estados" id="canceladas" value="4">
                            Canceladas
                        </label>
                    </div>
                </div>
  ...
  <div class="modal-dialog modal-lg" role="document" style="width: 92%">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <table class="table table-hover table-bordered" id="tblListadoDetalles">
              <thead>
                  <tr>
                      <th>SERVICIO</th>
                      <th>CLIENTE</th>
