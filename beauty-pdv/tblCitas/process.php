...
<?php 
	...
	switch ($_POST['opcion']) 
	{
		...
		case 'verAgenda':
			...
			$array[] = array('hora' => $row['cithora'], 'servicio' => $row['sernombre'], 'cliente' => $row['trcrazonsocial'], 'email' => $row['cliemail'], 'movil' => $row['trctelefonomovil'], 'duracion' => $row['serduracion'], 'usuagenda' => $row['usuarioAgendo'] );
